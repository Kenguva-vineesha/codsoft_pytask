...
l1 = Label(window, width=30, height=2,text='', font=('Helvetica', 30), bg='#E6E6FA')
l1.pack()
...
b4 = Button(window, width=5, height=1, text='x', font=('ariel', 30, 'bold'), fg='#fff', bg='#42484b', command=lambda:show('*'))
